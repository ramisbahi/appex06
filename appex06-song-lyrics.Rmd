...
top_20_lovell %>% 
  ggplot(aes(fct_reorder(word, n), n)) +
    ...
    labs(title = "Frequency of 'Concept Vague' lyrics", y = "", x = "")
...
top_20_soad %>% 
  ggplot(aes(fct_reorder(word, n), n)) +
    ...
    coord_flip() + 
    theme_minimal(base_size = 12) +
    labs(title = "Frequency of 'Mesmerize' lyrics", y = "", x = "")
```
...
lovell_lyrics %>%
  ...
  ggplot(aes(fct_reorder(word, n), n, fill = sentiment)) +
    ...
    labs(title = "Sentiments in Night Lovell Lyrics", x = "")
...
soad_lyrics %>%
  ...
  ggplot(aes(fct_reorder(word, n), n, fill = sentiment)) +
    ...
    facet_wrap(~ sentiment, scales = "free_y") +
    theme_minimal(base_size = 16) +
    labs(title = "Sentiments in SOAD Lyrics", x = "")
...
ggplot(combined, aes(x = `Night Lovell`, y = `System of a Down`)) +
  # hide discreteness
